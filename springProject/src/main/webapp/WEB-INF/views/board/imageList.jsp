...
<body>
	...
	<script>
		...
		function detail(e) {
			//find() 후손 요소 선택자를 이용하여 검색
			console.log($(e).find('.thumbnail-date').val());
			//$(e).find('.thumbnail-content').val();
			//$(e).find('.thumbnail.img').attr('src');
			//$(e).find('.thumbnail-title').text();
			//$(e).find('.thumbnail-writer').text();
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 portfolio-item" onclick="detail(this);">
						...
						<a class="portfolio-link" data-toggle="modal" href="#MyModal">
							...
							<img class="img-thumbnail img-fluid thumbnail-img" src="${ img.changeName }" alt="이미지" >
						</a>
