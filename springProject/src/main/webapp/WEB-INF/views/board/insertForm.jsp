...
<body>
    ...
    <div class="content">
        ...
        <div class="innerOuter">
            ...
            <form id="enrollForm" method="post" action="boardInsert" enctype="multipart/form-data">
                <table algin="center">
                    <tr>
                    ...
                    <tr>
                        <th colspan="2">
                            <div id="img-area">
                                <img id="preImage" src="https://t1.kakaocdn.net/friends/www/talk/kakaofriends_talk_2018.png" alt="카카오친구들">
                            </div>
                        </th>
                    </tr>
                </table>
