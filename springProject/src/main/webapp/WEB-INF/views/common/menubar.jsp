...
<body>
		<!-- menubar.jsp에 작성하여 공통작업 수행 가능 -->
		<!--   c:if를 이용하여 alertMsg가 있는지 확인
			jsp 요소를 script태그 내부에 쓰는 것은 좋지 않음
			
		-->
		<c:if test="${ not empty alertMsg }">
      <script> 
      
      		alertify.alert('코끼리도 흥', '${ alertMsg }');
			//alert도 브라우저의 한 요소이므로 html구조로 이루어져있음 >> js framework로 수정 가능
      </script>
    ...
    <div id="header">
        <div id="header_1">
            ...
            <div id="header_1_right">
                ...
                <c:choose>
	                <c:when test="${ sessionScope.loginUser eq null }"> <!-- empty 는 빈 문자열도 비교하므로 not empty 는 null값도 아니면서 문자열도 비어있지 않는 경우 -->
