...
<body>
    ...
    <div class="content">
        ...
        <div class="innerOuter">
            ...
            <form id="updateForm" method="post" action="noticeUpdate">
                <table algin="center">
                    <tr>
                        <th><label for="title">제목</label></th>
                        <td><input type="text" id="title" class="form-control" value="${notice.noticeTitle }" name="noticeTitle" maxlength="10" required></td>
                    </tr>
                    <tr>
                ...
                <input type="hidden" id="no" class="form-control" value="${notice.noticeNo }" name="noticeNo">
            </form>
        </div>
        <br><br>
